...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  { text: 'さて、ここからが肝心——【ギア】だ。今はGL3。ギアを上げると"攻撃力が上がる代わりに、動きが遅くなり、発熱する"。右のシフターでGL5まで上げてみよう。', goal: 'gearup5', dummy: 'stand' },
  { text: 'GL5は最強の火力＆"ガード割り"（高ギアはガードごと削れる）。硬い相手を崩したい時に上げるんだ。ただし遅く、被弾のリスクも上がる。［弱ボタンでつぎへ］', goal: 'info', dummy: 'stand' },
  { text: 'そして高ギアは発熱する。ゲージが満タンになると【オーバーヒート】——GL1に固定され、しばらく無防備だ。熱くなったらGL1へ下げて冷やせ。シフターでGL1まで下げてみよう。', goal: 'geardown1', dummy: 'stand' },
  { text: '達人の技【パーフェクトシフト】。変速した"直後"にもう一度変速すると、隙が消えて熱も一気に冷める。シフターを素早く2回——変速して即もう一度、で決めてみろ。', goal: 'perfectshift', dummy: 'stand' },
